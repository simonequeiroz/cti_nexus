...
<template>
  <PanelCard titulo="Dados válidos (padronizados)">
    <template #acoes>
    ...
    <DataTable v-if="store.quantidadeValidas" legenda="Prévia das linhas válidas da planilha" :colunas="COLUNAS">
    ...
    <EmptyMessage v-else>Nenhuma linha válida para mostrar.</EmptyMessage>
  </PanelCard>
</template>
